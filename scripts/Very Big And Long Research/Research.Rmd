...
В этом разделе представлены распределения всех переменных, к каждому из которых 
приложено возможное объяснение.

### Физические характеристики опрошенных
#### Пол
```{r} 
...
1. Феминизм явно не на стороне программистов. Доля женщин в исследованном сегменте
...
хватает игры Mario Bros, которая, как известно, не так требовательна к ресурсам ПК.
